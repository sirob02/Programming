...
/*
	...
	returns: the pointer to a (sum of previous a and b)
*/
matrix* add_matrix(matrix* a, matrix* b);


/*
	element-wise subtraction of the given matrices (subtracts b of a) (does not create a new matrix!)

	matrix* a: ...
	matrix* b: ...

	returns: the pointer to a (the difference of previous a and b)
*/
